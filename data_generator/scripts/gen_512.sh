#!/bin/bash
# Generate all benchmark datasets — Option A: 512 training samples
# Run from the repo root:  bash data_generator/scripts/gen_512.sh
#
# Produces in data_generator/datasets/:
#   gs_512.pt   [N_traj, 3, 2, T, 64, 64]
#   lv_512.pt   [N_traj, 10, 2, T]
#   bz_512.pt   [N_traj, 4, 3, T, 256]
#
# Recommended dataloader split ratios for 512 training samples:
#   --train_ratio 0.6305   (~512 train)
#   --val_ratio   0.1232   (~100 val)
#   (remainder    ~0.2463  (~200 test)
