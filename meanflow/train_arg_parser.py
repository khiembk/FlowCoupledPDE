...
def get_args_parser():
    ...
    parser.add_argument("--train_ratio", default=0.8, type=float, help="Fraction of trajectories for training (grayscott).")
    parser.add_argument("--val_ratio", default=0.1, type=float, help="Fraction of trajectories for validation (grayscott).")
    parser.add_argument("--time_stride", default=1, type=int, help="Stride over time axis when building (t_in, t_out) pairs.")
    ...
    parser.add_argument("--arch", default="unet", type=str, choices=["unet", "unet1d", "unet32", "unet32_lite", "unet_lite"], help="Architecture to use.")
